...
public:
  explicit NtsException(
      std::string const &message = "Not giving the context is bad");
...
public:
  explicit YeetException(std::string const &message = "yeet")
      : NtsException(message){};
  // public:
...
public:
  explicit InvalidReadException(std::string const &message)
      : ParserException(message){};
};
class InvalidSyntaxException : public InvalidReadException {
public:
  explicit InvalidSyntaxException(std::string const &message)
      : InvalidReadException(message){};
};
...
public:
  explicit ComputeException(std::string const &message)
      : RuntimeException(message){};
};
class SimulateException : public RuntimeException {
public:
  explicit SimulateException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidPinException : public RuntimeException {
public:
  InvalidPinException() = delete;
  explicit InvalidPinException(std::string const &message, size_t pin)
      : RuntimeException(message){};
  /**
...
public:
  ...
  explicit UnknownPinException(std::string const &message, size_t pin)
      : RuntimeException(message){};
  /**
...
public:
  explicit InvalidTypeException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidValueException : public RuntimeException {
public:
  explicit InvalidValueException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidLinkException : public RuntimeException {
public:
  explicit InvalidLinkException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidComponentException : public RuntimeException {
public:
  explicit InvalidComponentException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidCircuitException : public RuntimeException {
public:
  explicit InvalidCircuitException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidFileException : public RuntimeException {
public:
  explicit InvalidFileException(std::string const &message)
      : RuntimeException(message){};
};
class InvalidComponentNameException : public InvalidComponentException {
public:
  explicit InvalidComponentNameException(std::string const &message)
      : InvalidComponentException(message){};
};
...
public:
  AAAAAAAAAAAAAAAAAAAAAAAAException()
      : YeetException("AAAAAAAAAAAAAAAAAAAAAAAA"){};
};
} // namespace nts::Exception
