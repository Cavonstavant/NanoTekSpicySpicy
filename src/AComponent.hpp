...
namespace nts
{
    ...
    class AComponent : public IComponent {
        public:
            ...
            inline bool operator==(const IComponent &other) const final { return this->_name == other._name; }
            inline bool operator!=(const IComponent &other) const final { return !(*this == other); }
